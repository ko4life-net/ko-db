...
DECLARE	@Intel tinyint, @Cha tinyint, @Authority	tinyint, @Points	tinyint,	@Gold int, @Zone tinyint, @Bind	smallint, @PX int, @PZ int, @PY int, @strSkill varchar(20),	@strItem binary(400)
